module.exports = {
    ...
    head: [
      ...
      ['script', {}, `
        window.difyChatbotConfig = { token: 'SvrRPty7ACJCXznN', baseUrl: 'http://ai.conimi.com' };
        (function() {
          var embedScript = document.createElement("script");
          embedScript.src = "http://ai.conimi.com/embed.min.js";
          embedScript.id = "SvrRPty7ACJCXznN";
          embedScript.defer = true;
          var firstScript = document.getElementsByTagName("script")[0];
          firstScript.parentNode.insertBefore(embedScript, firstScript);
        })();
        var style = document.createElement("style");
        style.innerHTML = '#dify-chatbot-bubble-button { background-color: #1C64F2 !important; } #dify-chatbot-bubble-window { width: 24rem !important; height: 40rem !important; }';
